...
parser.add_argument('--first_channel_percentile', type=float, default=70.0)
...
for fileprefixname in fileprefixname_list:
    ...
    for filename in all_files:
        ...
        for contour in contours:
            ...
            if cell_intensity > 50 or cell_intensity < 15: continue
            ...
            first_channel_mask = (first_channel > percentile_intensity + 110)
    ...
    if fileprefixname == "wt+efgp gact 3 ll2h_":
        intensity1 = np.mean(all_intensity)
    if fileprefixname == "wt+efgp gact 3 api2h_":
        intensity2 = np.mean(all_intensity)
    # print("25 percentile", np.percentile(all_intensity, 25))
    # print("50 percentile", np.percentile(all_intensity, 50))
    # print("75 percentile", np.percentile(all_intensity, 75))
    print("")
...
fout.close()    
print("fold change", intensity1 / intensity2)