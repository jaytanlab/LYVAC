...
parser.add_argument('--first_channel', type=int, default=2)
parser.add_argument('--second_channel', type=int, default=0)
...
for fileprefixname in fileprefixname_list:
    ...
    for filename in all_files:
        ...
        for contour in contours:
            ...
            if args.mode == "single_total":
                ...
                percentile_intensity = np.percentile(first_channel[inside_cell], 75) + 100
    ...
    if fileprefixname == "2023.06.09 u2os ORP11-594 LAMP1-BLUE Great_ap25nM 0'-":
        intensity1 = all_intensity
    if fileprefixname == "2023.06.09 u2os ORP11-594 LAMP1-BLUE Great_ap25nM 120'-":
