...
for fileprefixname in fileprefixname_list:
    ...
    for filename in all_files:
        ...
        for contour in contours:
            ...
            if args.mode == "single_total":
                ...
                percentile_intensity = np.percentile(first_channel[cell_pixels[:, :, args.first_channel] > 0], 85) + 35
                # Calculate the valid mask of the first channel within the cell
    ...
    if fileprefixname == "20230923 u2os GFP-Lact-C2 L1-594_WT_api 0h-":
        intensity1 = all_intensity
    if fileprefixname == "20230923 u2os GFP-Lact-C2 L1-594_WT_api 2h-":
