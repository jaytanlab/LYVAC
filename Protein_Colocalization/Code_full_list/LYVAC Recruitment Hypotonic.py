...
for fileprefixname in fileprefixname_list:
    ...
    for filename in all_files:
        ...
        for contour in contours:
            ...
            if args.mode == "single_total":
                ...
                cell_intensity = np.percentile(first_channel[cell_pixels[:, :, args.first_channel] > 0], 10)
                ...
                percentile_intensity = np.percentile(first_channel[inside_cell], 90) + 75
                # Calculate the valid mask of the first channel within the cell
    ...
    if fileprefixname == "2022.12.26 U2OS WT+PD8-EGFP L2 CD63 Api2h Hypo1h L1R594 DAPI_a-Control-L2-594-":
        intensity1 = all_intensity
    if fileprefixname == "2022.12.26 U2OS WT+PD8-EGFP L2 CD63 Api2h Hypo1h L1R594 DAPI_b-Api-L2-594-":
