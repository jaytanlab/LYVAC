...
for fileprefixname in fileprefixname_list:
    ...
    if fileprefixname == "2023.06.15 U20S LYSOS-594, LAMP1-blue_metoclop5ramide 2mM_0h-":
        intensity1 = all_intensity
    if fileprefixname == "2023.06.15 U20S LYSOS-594, LAMP1-blue_metoclop5ramide 2mM_2h-":
