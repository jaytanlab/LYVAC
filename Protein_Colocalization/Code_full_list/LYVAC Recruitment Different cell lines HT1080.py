...
for fileprefixname in fileprefixname_list:
    ...
    if fileprefixname == "2023.06.09 HT1080 LYSOS-594 LAMP1-blue_AP25nM-0h-":
        intensity1 = all_intensity
    if fileprefixname == "2023.06.09 HT1080 LYSOS-594 LAMP1-blue_AP25nM-3h-":
