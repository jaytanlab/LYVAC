...
for fileprefixname in fileprefixname_list:
    ...
    if fileprefixname == "2022.10.26 U2OS PDZD8KO+PD8-DeltaXX-FG DAPI_3d-PD8KO+PD8FG-Control-":
        intensity1 = all_intensity
    if fileprefixname == "2022.10.26 U2OS PDZD8KO+PD8-DeltaXX-FG DAPI_3e-PDZD8KO+PDZD8FG-Api-":
