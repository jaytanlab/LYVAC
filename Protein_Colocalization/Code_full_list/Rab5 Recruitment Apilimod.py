...
for fileprefixname in fileprefixname_list:
    ...
    for filename in all_files:
        ...
        for contour in contours:
            ...
            if args.mode == "single_total":
                ...
                if np.sum(np.float32(inside_cell == True)) == 0: continue
    ...
    if fileprefixname == "2022.11.28 U2OS WT LAMP1 LAMP2 Rab7 Rab5 CD63 Control Api Hypo_2a-L1R594-R5M488-Control-":
        intensity1 = all_intensity
    if fileprefixname == "2022.11.28 U2OS WT LAMP1 LAMP2 Rab7 Rab5 CD63 Control Api Hypo_2b-L1R594-R5M488-Api-":
