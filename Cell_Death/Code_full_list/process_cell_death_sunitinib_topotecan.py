    ...
    for filename in all_files:
        ...
        for i_x in range(0, total_x):
            for i_y in range(0, total_y):
                ...
                elif "suni" in filename or "mone" in filename:
                    percentile = np.percentile(original[:, :, args.first_channel], 75) + 15
...
drug_names = ["suni"] # ["mone", "suni", "topo"]
